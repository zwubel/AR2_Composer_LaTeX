...
\subsection{Kontextmenü}\label{sec:kontextMenu}\todo[inline, color=yellow]{Laura und Lukas}
Zu Beginn des Projektes wurde sich, wie in Kapitel \textcolor{red}{??} näher erläutert, mit den Mitarbeitern eines Architekturbüros zusammengesetzt. Als Zielgruppe konnten diese Ideen und Inspirationen liefern, was für den \textit{MaRC} wichtig ist. Unter Anderem hat sich dabei gezeigt, dass eine detaillierte Beschreibung der einzelnen Gebäude erwünscht ist. Diese Systemkomponente wurde in Form eines Kontextmenüs umgesetzt, welches wie Kapitel~\ref{}
...
\subsubsection{Architektur Berechnung} \label{sec:KontextMenuInhalt}\todo[inline]{Laura}
