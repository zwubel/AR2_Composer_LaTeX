...
\subsubsection{Serverseitige Netzwerkanbindung}\label{sec:serverClient}
...
\subsubsection{Anfasser für Marker-Skalierung}\label{sec:markerHandles}\todo[inline, color = green]{Paul}
...
\subsection{Tischmenü}\label{sec:TableMenü}\todo[inline, color=green]{Paul}
\todo[inline, color=red]{Lukas}
...
\subsubsection{Speichern von Szenen}\label{Speichern}\todo[inline, color=green]{Paul}
\todo[inline, color=red]{Lukas}
...
\subsubsection{Match Modus}\label{MatchModus}\todo[inline,color=green]{Paul}
\todo[inline, color=red]{Lukas}
...
%\todo[inline, backgroundcolor=green]{geschrieben: Laura}
%\todo[inline, color=red]{korrigiert:Vera}
...
\subsubsection{Korrespondierende Punktepaare} \label{sec:Korrespondenz} 
%\todo[inline, color=green]{geschrieben: Laura}
%\todo[inline, color=red]{korrigiert: Vera}
...
%\todo[inline, color=green]{geschrieben: Laura}
%\todo[inline, color=red]{korrigert: Vera}
...
%\todo[inline, backgroundcolor=green]{geschrieben: Laura und Vera}
%\todo[inline, color=red]{korrigiert: Laura}
