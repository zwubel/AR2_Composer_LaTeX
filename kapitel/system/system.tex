...
\begin{figure}[H]
		...
		\includegraphics[width=0.65\textwidth , trim = 0mm 65mm 270mm 0mm, clip]{Bilder/cameraCalib.jpg}
			...
			\caption{Bildunterschrift. \cite{Meisel:77890}}
	\end{figure}
...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\Absatzbox{}
		& \textbf{Transformation} & \textbf{Komponenten}&\textbf{Koordinaten}\\
		\hline
		$\overrightarrow{x}$ & &$x$,$y$,$z$& Weltkoordinaten\\
		\cline{2-4}
		$\downarrow$ & Koordinatentransformation & & \\
		\cline{2-4}
		$\overrightarrow{x}^P$ & &$x^P$,$y^P$,$z^P$& Projektionszentrumkoordinaten\\
		\cline{2-4}
		$\downarrow$ & Projektion & & \\
		\cline{2-4}
		$\overrightarrow{x}^P_Z$ & &$u^Z$,$v^Z$,$-c$& Projektionszentrumkoordinaten\\
		\cline{2-4}
		$\downarrow$ & Linsenverzeichnung & & \\
		\cline{2-4}	
		$\overrightarrow{x}^P_D$ & &$u^D$,$v^D$,$-c$& Verzeichnungskoordinaten \\
		\cline{2-4}
		$\downarrow$ & Bildebenenverkippung & & \\
		\cline{2-4}		
		$\overrightarrow{x}^V$ & &$u^V$,$v^V$,$-c^V$& Verkippungskoordinaten\\
		\cline{2-4}
		$\downarrow$ & Bildhauptpunktverschiebung & & \\
		\cline{2-4}
		$\overrightarrow{u}$ & &$u$,$v$ & Sensorkoordinaten\\
		\hline
	\end{tabular}
