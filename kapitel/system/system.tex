...
\subsubsection{Serverseitige Netzwerkanbindung}\todo[inline, color=green]{Laura}
...
\subsubsection{Speichern und Laden der Kalibrierungen}\label{sec:saveCalib}\todo[inline]{Laura}
...
\subsection{Verfolgung der Identitäten}\todo[inline]{Vera}
