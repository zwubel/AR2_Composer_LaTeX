...
\subsubsection{Computer zur Ausführung der Unity-Simulation}\label{sec:UnityComp}\todo[inline] {Lukas}
...
\todo[inline]{Beim nächsten Mal in der TH nachschauen...}
...
\subsubsection{Computer zur Ausführung der Tracking-Anwendung}\label{sec:TrackingComp}\todo[inline]{Vera}
...
\subsubsection{HTC Vive}\label{sec:Vive} \todo[inline]{Laura}
...
\subsubsection{IDS uEye 164LE-C}\label{sec:uEye} \todo[inline] {Vera}
...
\subsubsection{ArUco Marker} \label{sec:aruco} \todo[inline]{Vera}
...
\subsubsection{Würfel Marker}\label{sec:WürfelMarker} \todo[inline]{Vera}
...
\subsubsection{Ovrvision Pro}\label{sec:ovrvision}\todo[inline]{Lukas}
...
\end{figure}
\subsubsection{Webcam}\label{sec:webcam} \todo[inline]{Vera}
...
\subsubsection{Unity}\label{sec:unity}\todo[inline]{Lukas}
...
\subsubsection{Visual Studio 2015}\label{sec:VisualStudio} \todo[inline] {Vera}
...
\subsubsection{OpenCV} \label{sec:OpenCV} \todo[inline] {Vera}
...
\subsubsection{Winsoc}\todo[inline] {Laura und Lukas}
