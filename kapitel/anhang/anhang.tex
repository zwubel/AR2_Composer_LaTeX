...
\begin{figure}[H] 
	...
	\caption[Schachbrett zur Kamerakalibrierung]{Um den Faktor 0.6 skaliertes Schachbrett zur Kamerakalibrierung. \\ Download: \url{http://www.mrpt.org/downloads/camera-calibration-checker-board_9x7.pdf}}
	\label{fig:schachPDF}
\end{figure}
\newpage
...
\begin{figure}[htbp]
	\centering
	\includegraphics[angle=90,scale=.9, trim=1.5cm 8cm 3.5cm 0cm, clip]{kapitel/anhang/Kapazitaetsplan.pdf}	
	 \caption[Ressourcenplan von \textit{MArC}]{Ressourcenplan von \textit{MArC} in tabellarischer Form.}
	\label{fig:ressourcenplan}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[angle=90,scale=.9, trim=1.5cm 0cm 3.5cm 0cm, clip]{kapitel/anhang/Kapazitaetsplan2.pdf}
	
	 \caption[Mitarbeiterressourcenplan von \textit{MArC}]{Mitarbeiterressourcenplan von \textit{MArC} als Diagramm.}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[angle=90,scale=.9, trim=1.5cm 9cm 3.5cm 0cm, clip]{kapitel/anhang/Kostenplan.pdf}
	 \caption[Kostenplan von \textit{MArC}]{Kostenplan von \textit{MArC}.}
